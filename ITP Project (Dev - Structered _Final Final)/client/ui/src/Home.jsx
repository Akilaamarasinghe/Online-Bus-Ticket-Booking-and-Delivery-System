...
const Home = () => {
    ...
    const renderCalendarDays = () => {
        ...
        for (let i = 0; i < firstDayOfMonth; i++) {
            calendarDays.push(<td key={`empty-${i}`} className="calendar-empty"></td>);
        }

        for (let i = 1; i <= daysInMonth; i++) {
            const isCurrentDay = i === currentDate ? 'calendar-current-day' : '';
            calendarDays.push(<td key={i} className={`calendar-day ${isCurrentDay}`} onClick={() => handleDayClick(i)}>{i}</td>);
        }
    ...
    return (
        ...
        <Carousel interval={3000} nextLabel="" prevLabel="">
            <Carousel.Item style={{ backgroundImage: `url('https://static.vecteezy.com/system/resources/previews/003/545/351/non_2x/illustration-of-an-autumn-city-people-are-waiting-for-the-bus-at-the-bus-stop-a-man-and-a-boy-go-hand-in-hand-to-the-approaching-bus-urban-infostructure-vector.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <Card className="home-card text-center">
                    <Card.Body className="d-flex flex-column justify-content-center align-items-center">
                        <Card.Title>Book Tickets</Card.Title>
                        <Card.Text>
                            Easily book your bus tickets online.
                        </Card.Text>
                        <Link to="//form">
            ...
            <Carousel.Item style={{ backgroundImage: `url('https://static.vecteezy.com/system/resources/thumbnails/041/000/967/original/airport-baggage-pile-line-2d-object-animation-packing-bags-rucksack-handbag-flat-color-cartoon-4k-alpha-channel-tourism-showing-up-suitcase-luggage-animated-item-on-white-background-video.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <Card className="home-card text-center">
                    <Card.Body className="d-flex flex-column justify-content-center align-items-center">
                        <Card.Title>Add a Luggage</Card.Title>
                        <Card.Text>
                            Add luggage to your booking securely.
                        </Card.Text>
                        <Link to="/insert">
            ...
            <Carousel.Item style={{ backgroundImage: `url('https://static.vecteezy.com/system/resources/previews/001/879/587/non_2x/fill-in-choices-in-an-exam-or-survey-make-the-right-choice-to-get-business-solutions-and-feedback-illustration-concept-for-landing-page-web-ui-banner-flyer-poster-template-background-free-vector.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <Card className="home-card text-center">
                    <Card.Body className="d-flex flex-column justify-content-center align-items-center">
            ...
            <div className="row mt-3">
                <div className="col-md-6">
                    <Card className="clock-card text-center" style={{ backgroundColor: '#ff9999' }}>
                        <Card.Body>
                            ...
                            <div className="clock">
                                ...
                                <p className="time fs-1 fw-bold">{currentTime.toLocaleTimeString()}</p>
                            </div>
                        </Card.Body>
                    </Card>
                </div>
                <div className="col-md-6">
                    <Card className="calendar-card text-center" style={{ backgroundColor: '#006666' }}>
                        <Card.Body>
                ...
                <div className="col-md-6" style={{ marginTop: '-9rem' }}>
                    <Card className="support-card text-center" style={{ backgroundColor: '#9999ff' }}>
                        <Card.Body>
