    ...
    show ? (
      <div className="modal" style={{ display: 'block', backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
            ...
            {busnum.map(num => (
              ...
              <textarea className="form-control mb-2" name="content" value={formData.content} onChange={handleChange} />
              <input type="number" className="form-control mb-2" name="rating" value={formData.rating} onChange={handleChange} />
            </div>
